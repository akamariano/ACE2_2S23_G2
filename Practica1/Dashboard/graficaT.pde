...
public class GraficoT extends PApplet { // Clase Grafico que extiende de PApplet
...
/* --------------------------------------->>>> DESCOMENTAR ESTO PARA RECIBIR DATOS DE LA DATABASE ------------------------>>>
  ...
  public void draw() { // Método para dibujar en la pantalla
    ...
    printText("Temperatura", 30, 430, 60, 255, 255, 255);
    popStyle();
  }
